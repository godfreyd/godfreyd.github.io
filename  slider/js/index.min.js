...
/* 
	РјРµС‚РѕРґ decl РѕР±СЉРµРєС‚Р° BEM СѓРєР°Р·С‹РІР°РµС‚ РґР»СЏ РєР°РєРѕРіРѕ Р±Р»РѕРєР° РґРµР»Р°РµС‚СЃСЏ РґРµРєР»Р°СЂР°С†РёСЏ. 
	
	РџРµСЂРІС‹Рј РїР°СЂР°РјРµС‚СЂРѕРј СѓРєР°Р·С‹РІР°РµС‚СЃСЏ РёРјСЏ Р±Р»РѕРєР°, РґР°Р»РµРµ
    {
        РјРµС‚РѕРґС‹ СЌРєР·РµРјРїР»СЏСЂР° (РґРёРЅР°РјРёС‡РµСЃРєРёРµ РјРµС‚РѕРґС‹)
    },
    {
...
{
    onSetMod: { // СЃР»СѓР¶РµР±РЅРѕРµ СЃРІРѕР№СЃС‚РІРѕ onSetMod СЂРµР°Р»РёР·СѓРµС‚ РІРѕР·РјРѕР¶РЅРѕСЃС‚СЊ СЂРµР°РіРёСЂРѕРІР°С‚СЊ РЅР° РїРѕСЏРІР»РµРЅРёРµ РёР»Рё РёСЃС‡РµР·РЅРѕРІРµРЅРёРµ РјРѕРґРёС„РёРєР°С‚РѕСЂРѕРІ
	
        js: { // СѓРєР°Р·С‹РІР°РµРј РјРѕРґРёС„РёРєР°С‚РѕСЂ
            inited: function() { // Р·РЅР°С‡РµРЅРёРµ inited (С‚Р°РєРёРј РѕР±СЂР°Р·РѕРј СЂРµР°Р»РёР·СѓРµРј С‡С‚Рѕ-С‚Рѕ  РІСЂРѕРґРµ $( document ).ready() ). 
				/* РёРЅРёС†РёР°Р»РёР·Р°С†РёСЏ РѕР±СЂР°Р±РѕС‚С‡РёРєРѕРІ СЃРѕР±С‹С‚РёР№ РЅР° РєРЅРѕРїРєР°С… Рё Р·Р°РїСѓСЃРє update */
				
				/* РјРµС‚РѕРґ bindTo СѓРјРµРµС‚ СЃР»СѓС€Р°С‚СЊ СЃРѕР±С‹С‚РёСЏ РЅР° Р±Р»РѕРєРµ, РІР»РѕР¶РµРЅРЅС‹С… РІ Р±Р»РѕРє СЌР»РµРјРµРЅС‚Р°С… Рё СЂРµР°РіРёСЂРѕРІР°С‚СЊ РЅР° РЅРёС… */
				this.bindTo('mouseenter', this.onEnter);
                this.bindTo('mouseleave', this.onLeave);

				// РЅР°С…РѕРґРёРј РєРЅРѕРїРєРё Рё РЅР° СЃРѕР±С‹С‚РёСЏ РєР»РёРє РІС‹Р·С‹РІР°РµРј РєРѕР»Р±СЌРє. 
                this.bindTo(this.elem('control'), 'click', function(e) { // РјРµС‚РѕРґ this.elem РєСЌС€РёСЂСѓРµРјС‹Р№
				// С‚Р°Рє РєР°Рє РєРЅРѕРїРѕРє РґРІРµ РјС‹ РѕРїСЂРµРґРµР»СЏРµРј С‡РµРјСѓ СЂР°РІРЅРѕ Р·РЅР°С‡РµРЅРёРµ РјРѕРґРёС„РёРєР°С‚РѕСЂР° СЌР»РµРјРµРЅС‚Р° slide РїРѕ РєРѕС‚РѕСЂРѕРјСѓ РєР»РёРєРЅСѓР»Рё
    ...
    prev: function() {
		/* РїРµСЂРµС…РѕРґ Рє РїСЂРµРґС‹РґСѓС‰РµРјСѓ СЃР»Р°Р№РґСѓ */
		if (this.sliding) return;
		return this.slide('prev');
    },

    slide: function(type) {
        var active = this.findElem('item', 'state', 'active'), // РЅР°С…РѕРґРёРј С‚РµРєСѓС‰РёР№ Р°РєС‚РёРІРЅС‹Р№ СЌР»РµРјРµРЅС‚
            next = next || active[type](), // РЅР°С…РѕРґРёРј СЃР»РµРґСѓСЋС‰РёР№
            fallback  = type == 'next' ? 'first' : 'last';

        this.sliding = true; // С„Р»Р°Рі

        next = next.length ? next : this.elem('item')[fallback](); // РµСЃР»Рё СЃР»РµРґСѓСЋС‰РёР№ РЅРµ РїРѕРЅСЏС‚РЅС‹Р№, С‚Рѕ РїРѕР·РѕРІРµРј РѕР±С‹С‡РЅСѓСЋ jquery С„СѓРЅРєС†РёСЋ Рё РѕРїСЂРµРґРµР»РёРј СЃР»РµРґСѓСЋС‰РёР№ item

        if (this.hasMod(next, 'state', 'active')) return; // РїРµСЂРµСЂР°Р±Р°С‚С‹РІР°РµРј РµСЃР»Рё Сѓ СЃР»РµРґСѓСЋС‰РµРіРѕ item РµСЃС‚СЊ РјРѕРґРёС„РёРєР°С‚РѕСЂ state_active

        var nextIdx = this.elem('item').index(next); // РѕРїСЂРµРґРµР»СЏРµРј РёРЅРґРµРєСЃ СЃР»РµРґСѓСЋС‰РµР№ РєР°СЂС‚РёРЅРєРё 0,1,2,3,4
		
		localStorage["saveIdx"] = nextIdx; // СЃРѕС…СЂР°РЅСЏРµРј РґР°РЅРЅС‹Р№ РёРЅРґРµРєСЃ
